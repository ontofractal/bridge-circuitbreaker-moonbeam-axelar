...
export interface IERC20CrossChainInterface extends utils.Interface {
  functions: {
...
export interface IERC20CrossChain extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC20CrossChainInterface;
